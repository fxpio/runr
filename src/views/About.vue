      ...
      <v-flex xs12 sm10 offset-sm1 md8 offset-md2 xl6 offset-xl3>
        ...
        <v-card flat>
          <v-list two-line>
            ...
            <v-list-tile target="_blank" href="https://github.com/fxpio/fxp-bibscan-njuko/issues">
              <v-list-tile-avatar>
            ...
            <v-list-tile target="_blank" href="https://github.com/fxpio/fxp-bibscan-njuko/releases">
              <v-list-tile-avatar>
        ...
        <v-card flat>
          <v-list two-line>
            ...
            <v-list-tile target="_blank" href="https://github.com/fxpio/fxp-bibscan-njuko">
              <v-list-tile-avatar>
...
<script lang="ts">
  ...
  export default class About extends Vue {
    ...
    public get authorFullName(): string {
      return 'François Pluchino';
    }

    public get authorGithubName(): string {
      return 'francoispluchino';
    }

    public get authorEmail(): string {
      return 'francois.pluchino@gmail.com';
    }

    public get authorGithubUrl(): string {
      return 'https://github.com/francoispluchino';
    }

    public metaInfo(): MetaInfo {
      return {
        title: this.$t('views.about.title') as string,
      };
    }
  }
</script>
