...
export default {
    ...
    'views.edition-add.title': 'Add a edition',
    'views.edition-add.identifier': 'Edition identifier',
    'views.edition-add.api-key': 'API Key',
    'views.edition-add.help.into': 'To get your login details of edition, connect you to the Njuko app, then:',
    'views.edition-add.help.step-1': 'Click on the "Manage my edition" button of the desired edition in the list',
    'views.edition-add.help.step-2': 'Click on the "Advanced Settings" menu',
    'views.edition-add.help.step-3': 'Use the values in the "API" section',
    ...
    'views.bib-label.title': 'Bib label',
    'views.bib-labels.title': 'Bib labels',
